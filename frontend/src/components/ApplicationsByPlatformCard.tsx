    ...
    ">
      ...
      <div className="flex flex-col gap-3">
        {applicationsByPlatform.map(platform => {
          ...
          return (
            <div key={platform.platform_name} className="flex justify-between items-center py-2 border-b border-white/10">
              <span className="text-white/80 font-medium">{platform.platform_name}</span>

              <div className="flex items-center gap-3">
                <span className="text-white/90 font-bold min-w-[30px] text-right">{platform.count}</span>
