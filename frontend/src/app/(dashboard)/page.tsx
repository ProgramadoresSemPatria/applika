...
import ApplicationAnalyticsDashboard from "@/features/home/components/ApplicationAnalyticsDashboardCard";
...
import AverageDaysChartCard from "@/features/home/components/AverageDaysChartCard";
import ApplicationsByPlatformCard from "@/features/home/components/ApplicationsByPlatformCard";
import ApplicationModeCard from "@/features/home/components/ApplicationModeCard";
      ...
      <section className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <DashboardCard>
          <ApplicationsByPlatformCard
            applicationsByPlatform={platformsSample}
            totalApplications={totalApps}
          />
        </DashboardCard>
        <DashboardCard>
          <ApplicationModeCard
            applicationsByMode={modesSample}
            totalApplications={totalApps}
          />
        </DashboardCard>
        <DashboardCard fullWidth>
